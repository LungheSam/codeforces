...
"""
input_drinks=int(input().strip())
input_orange_fractions=input().strip().split(" ")
input_orange_fractions=list(map(int,input_orange_fractions))

print(sum(input_orange_fractions)/input_drinks)